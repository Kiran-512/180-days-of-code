...
Even if child class is not able to implements those method, then declare the child class also as an abstratc class and implement the same method in next child class 
...
YES, becasue we can use it with the constructor chaining to reach the Object class and for initialising fields of the abstaract class which mayhave the concerete methods other than abstract methods!
...
//below method is already defined by the parent of Twowheelers hence its not neccesary to rewrite these methods as we have made the TwoWheeler class also as an abstract class
  //abstract void engineCpacity();
 ...
 abstract class FourWheeler extends vehicle {
  ...
  abstract void engineCpacity(); // No need to declare this method again
}
