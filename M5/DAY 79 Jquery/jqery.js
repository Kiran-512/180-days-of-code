$(() => {
    ...
    t1.addEventListener("blur", () => {
      ...
      if (!found) {
        ...
        document.querySelector("#wh").innerText =
          "number is new to be added";
      } else {
    ...
    add.addEventListener("click", () => {
      ...
      if (output) document.querySelector("#wh").innerText = "number added";
      else document.querySelector("#wh").innerText = "number not added";
    ...
    deletebutton.addEventListener("click", () => {
      ...
      else document.querySelector("#wh").innerText = "number not found";
    ...
    edit.addEventListener("click", () => {
      ...
      else document.querySelector("#wh").innerText = "number not modified";
