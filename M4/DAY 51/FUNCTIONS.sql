...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------ |
| **String**         | `ASCII()`, `BIN()`, `BIT_LENGTH()`, `CHAR()`, `CHAR_LENGTH()`, `CHARACTER_LENGTH()`, `CONCAT()`, `CONCAT_WS()`, `ELT()`, `EXPORT_SET()`, `FIELD()`, `FIND_IN_SET()`, `FORMAT()`, `INSERT()`, `INSTR()`, `LCASE()`, `LEFT()`, `LENGTH()`, `LOAD_FILE()`, `LOCATE()`, `LOWER()`, `LPAD()`, `LTRIM()`, `MAKE_SET()`, `MID()`, `OCT()`, `ORD()`, `POSITION()`, `QUOTE()`, `REGEXP()`, `REPLACE()`, `REVERSE()`, `RIGHT()`, `RPAD()`, `RTRIM()`, `SOUNDEX()`, `SPACE()`, `STRCMP()`, `SUBSTRING()`, `SUBSTRING_INDEX()`, `TRIM()`, `UCASE()`, `UNHEX()`, `UPPER()`                                                                                                                                                                                                                                                                                                | Manipulate and query string values   |
| **Numeric**        | `ABS()`, `ACOS()`, `ASIN()`, `ATAN()`, `ATAN2()`, `CEIL()`, `CEILING()`, `COS()`, `COT()`, `DEGREES()`, `DIV()`, `EXP()`, `FLOOR()`, `LN()`, `LOG()`, `LOG10()`, `LOG2()`, `MOD()`, `PI()`, `POW()`, `POWER()`, `RADIANS()`, `RAND()`, `ROUND()`, `SIGN()`, `SIN()`, `SQRT()`, `TAN()`, `TRUNCATE()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Perform mathematical calculations    |
| **Date/Time**      | `ADDDATE()`, `ADDTIME()`, `CURDATE()`, `CURRENT_DATE()`, `CURRENT_TIME()`, `CURRENT_TIMESTAMP()`, `CURTIME()`, `DATE()`, `DATEDIFF()`, `DATE_ADD()`, `DATE_SUB()`, `DAY()`, `DAYNAME()`, `DAYOFMONTH()`, `DAYOFWEEK()`, `DAYOFYEAR()`, `EXTRACT()`, `FROM_DAYS()`, `FROM_UNIXTIME()`, `GET_FORMAT()`, `HOUR()`, `LAST_DAY()`, `LOCALTIME()`, `LOCALTIMESTAMP()`, `MAKE_DATE()`, `MAKETIME()`, `MICROSECOND()`, `MINUTE()`, `MONTH()`, `MONTHNAME()`, `NOW()`, `PERIOD_ADD()`, `PERIOD_DIFF()`, `QUARTER()`, `SECOND()`, `SEC_TO_TIME()`, `STR_TO_DATE()`, `SUBDATE()`, `SUBTIME()`, `SYSDATE()`, `TIME()`, `TIME_FORMAT()`, `TIME_TO_SEC()`, `TIMEDIFF()`, `TIMESTAMP()`, `TIMESTAMPADD()`, `TIMESTAMPDIFF()`, `TO_DAYS()`, `UNIX_TIMESTAMP()`, `UTC_DATE()`, `UTC_TIME()`, `UTC_TIMESTAMP()`, `WEEK()`, `WEEKDAY()`, `WEEKOFYEAR()`, `YEAR()`, `YEARWEEK()` | Work with dates and times            |
| **Aggregate**      | `AVG()`, `COUNT()`, `GROUP_CONCAT()`, `MAX()`, `MIN()`, `STD()`, `STDDEV()`, `STDDEV_POP()`, `STDDEV_SAMP()`, `SUM()`, `VAR_POP()`, `VAR_SAMP()`, `VARIANCE()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Summarize or aggregate multiple rows |
| **System/Session** | `BENCHMARK()`, `CONNECTION_ID()`, `CURRENT_USER()`, `DATABASE()`, `FOUND_ROWS()`, `LAST_INSERT_ID()`, `PASSWORD()`, `SCHEMA()`, `SESSION_USER()`, `SYSTEM_USER()`, `USER()`, `VERSION()`, `UUID()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | System info, session, or metadata    |
| **Conditional**    | `CASE`, `IF()`, `IFNULL()`, `NULLIF()`, `COALESCE()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Conditional logic                    |
